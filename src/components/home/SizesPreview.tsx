...
export default function SizesPreview() {
  const { headline, body, image, cta } = siteContent.home.sizesPreview;
  return (
    <Section variant="light">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <ImageCard src={image} alt={headline} aspectRatio="aspect-video" />
        <div className="space-y-8">
          <span className="text-xs font-bold uppercase tracking-widest text-teal underline underline-offset-8">Fit Guide</span>
          ...
          <CTAButton to="/sizes" variant="primary">
            {cta}
          </CTAButton>
        </div>
      </div>
